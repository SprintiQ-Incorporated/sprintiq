...
import { DependencyBadge } from "@/components/workspace/ai/dependencies-display";
              ...
              <TooltipProvider delayDuration={200}>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <span className="inline-flex items-center justify-center h-6 w-6 rounded-full bg-amber-500/15 text-amber-600">
                      <Zap className="h-3 w-3" />
                    </span>
                  </TooltipTrigger>
                  <TooltipContent side="top" className="text-xs">
                    <p>Claude Code session active</p>
                    <p className="text-muted-foreground">
                      {activeSessionInfo.userName} &mdash;{" "}
                      {formatDistanceToNow(new Date(activeSessionInfo.startedAt))}
                    </p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
